...
namespace IT2030_Lab04_Mosinski_MusicStore.Controllers
{
    public class StoreManagerController : Controller
    {
        ...
        // This is the method that is going to be called through the AJAX 
        ...
        {
            Album album = db.Albums.OrderBy(a => System.Guid.NewGuid()).First();
            album.Price *= .5m;

            return album;
        }

        // This is the action result handler for the Ajax Artist Search bar
        ...
        // This method gets called by the ArtistSearch method
        private List<Artist> GetArtists(string searchString)
        {
            return db.Artists.Where(x => x.Name.Contains(searchString)).ToList();            
        }

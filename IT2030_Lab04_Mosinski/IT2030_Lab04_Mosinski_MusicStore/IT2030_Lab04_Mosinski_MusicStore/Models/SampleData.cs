...
{
    // This is a class of sample data that takes the DataBase context class 
    // This class initializes the database and seeds/plants the data into the database.
	public class SampleData : DropCreateDatabaseIfModelChanges<IT2030_Lab04_Mosinski_MusicStoreDB>
    {
        protected override void Seed(IT2030_Lab04_Mosinski_MusicStoreDB context)
        {
